							...
							<div class="row">
									...
									<!--thumbnail-->
										<div class="ratio_360-202 image-wrapper">
											<a href="#">
												<center>
													<img class="img-fluid lazy" style="width='100'" src="{{ asset('/data_file/'.$posts->file) }}" width="300px" height="300px" alt="Responsive image">
												</center>
									...
									<div class="col-12">
										<div class="card-body pt-3 pt-sm-0 pt-md-3 pt-lg-0">
												...
												<a href="#">{{ $posts->judul }}</a>
												</h3>
												<!--author and date-->
												<div class="card-text mb-2 text-muted small">
												<span class="d-none d-sm-inline mr-1">
												<a class="font-weight-bold" href="#">{{ $posts->name }}</a>
												</span>
											<time datetime="2019-10-21"></time>
												</div>
												<!--description-->
											<p class="card-text text-justify">{{ $posts->keterangan }}</p>
												<!-- read more button -->
