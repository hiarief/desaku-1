...
@section('createfam')
        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb mb-8">
                <li class="breadcrumb-item ative">Keterangan Kelakuan Baik</li>
            </ol>
                        {{-- //status --}}
                          @if (session('status'))
                        ...
                        <div class="row" >
                          <div class="col-12">
                              ...
                              <form method="POST" action="/suratskb">
                                  @csrf
                                  <div class="form-group">
                                  <label for="Nomor" class="mt-8">NOMOR</label>
                                  <input type="text" class="form-control @error('nomor') is-invalid @enderror" id="nomor"  name="nomor" value="{{$skb}}" readonly>
                                  ...
                                  <div class="form-group">
                                      <input type="hidden" class="form-control  @error('jenis') is-invalid @enderror" id="jenis"  name="jenis" value="SKB">
