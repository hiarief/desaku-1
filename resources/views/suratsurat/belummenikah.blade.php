...
@section('createfam')
        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb mb-8">
                <li class="breadcrumb-item ative">Keterangan Belum Menikah</li>
            </ol>
                        {{-- //status --}}
                          @if (session('status'))
                        ...
                        <div class="row" >
                          <div class="col-12">
                              ...
                              <form method="POST" action="/suratmenikahsimpan">
                                  ...
                                  <input type="text" class="form-control @error('nomor') is-invalid @enderror" id="nomor"  name="nomor" value="{{$surats}}" readonly>
