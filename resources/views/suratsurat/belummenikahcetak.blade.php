...
<head>
    ...
    <title>SKBM</title>
        ...
        <tr>
            <td colspan="3" align="center"><font size="3"><u>SURAT KETERANGAN BELUM MENIKAH</u></font></td>
        </tr>
        <tr>
            <td></td>
        </tr>
        ...
        <table align="center" border="0">
            ...
            <tr>
                ...
                <td width="100"><font size="2"> : {{ $familycards->tempat_lahir }} / {{ $familycards->tgl_lahir }}</font></td>
            </tr>
            {{-- <tr>
            ...
            <tr>
                ...
                <td width="100"><font size="2"> : {{ $familycards->pekerjaan }} </font></td>
            </tr>
            <tr>
            ...
            <br>
            <tr>
                <td height="20" colspan="2"><font size="2">Anak Dari Seorang Ayah :</font></td>
            </tr>
            <tr>
                <td width="100"><font size="2">Nama</font></td>
            ...
            <br>
            <tr>
                <td height="20" colspan="2"><font size="2">Dengan seorang Ibu :</font></td>
            </tr>
            <tr>
                <td width="100"><font size="2">Nama</font></td>
                <td width="100"><font size="2"> :</font></td>
        ...
        <tr>
            <td width="500"><font size="2" align="justify">Berdasarkan data kependudukan kampung, nama tersebut diatas benar-benar warga Desa Sumurbandung, Kecamatan Jayanti, Kabupaten Tangerang,
                dan menurut pengamatan kami dan data yang ada sampai saat ini nama tersebut diatas belum terkait hubungan pernikahan</font></td>
        </tr>
        <tr>
            <td width="400" colspan="2"><font size="2" align="justify">Demikian surat keterangan ini dibuat dengan sebenarnya, untuk dapat dipergunakan sebagaimana mestinya.</font></td>
        </tr>
        <tr>
            <td  width="400" colspan="2" align="right"><font size="2">Tangerang,...........................................</font></td>
        </tr>
        <tr>
            <td  width="400"  height="10" colspan="2"></td>
        </tr>
    </table>
    <table width="500" border="0">
        <tr>
            <td  colspan="2" align="right" ><font size="2">Kepala Desa Sumurbandung</font></td>
        </tr>
        <tr>
    ...
    <table width="470" border="0">
        <tr>
            <td colspan="2" align="right"><font size="2">Ahmad Jajuli,SE</font></td>
        </tr>
    </table>
<body>
</body>
